...
<div class="container">
    <main>
        ...
        $proReader = "SELECT * FROM house WHERE ID='$proID'";
        ...
        <div class="single-product">
            ...
            <div class="product-detail">
                ...
                <div class="product-price">
                    <h3><?php echo $detailFetch['Price']?> ETB/sq</h3>
                </div>
                <hr>
                <p>How many rooms?</p>
                <hr>
                <div class="product-cart">
                    <form id="cart-form">
                        <div class="form-group">
                            <input type="number" class="cart-number" placeholder="rooms" name="cartNumber" min="50" max="10000">
                            <a href="addToCart.php?cart_id=<?php echo $detailFetch['ID'];?>&cart_name=<?php echo $detailFetch['Name'];?>&cart_price=<?php echo $detailFetch['Price'];?>&cart_photo=<?php echo $detailFetch['Picture']?>" name="add_to_cart" style="background-color: yellow"> Add To Orderlist</a>
                        </div>
                    </form>
