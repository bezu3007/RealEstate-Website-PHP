...
class LoginForm
{
    ...
    public function loginUser(): void
    {
        if (isset($_POST['login'])) {
            ...
            $stmt = $this->dbConnector->prepare("SELECT * FROM user_profile WHERE username = ?");
    ...
    public function renderForm(): void
    {
        ...
        <head>
            ...
            <!-- Title -->
            <title>Login - ARARAT REAL STATES</title>
            <!-- Style Sheet -->
                ...
                <div class="account-detail">
                    <div class="billing-detail">
                        <form class="checkout-form" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>"
                            ...
                            <div style="padding-top: 20px;">
                                Are you an admin? <a href="../ip_pro/login.php"> Login</a>
                            </div>
                        </form>
                    </div>
                </div>
