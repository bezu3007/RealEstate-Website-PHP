...
<head>
    ...
    <!-- Title -->
    <title>My Cart - Ararat Real state</title>
    <!-- Style Sheet -->
                                    ...
                                    foreach ($_SESSION['cart'] as $key => $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 60%;">
                                                ...
                                                <br>
                                                <h3>Price: <?php echo $value['item_price'] ?>M</h3>
                                                <br>
...
$shoppingCart = new ShoppingCart($DB_Connector);
